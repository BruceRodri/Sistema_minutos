                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <?php else: ?>
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <button type="button" data-editar-estado class="rounded-lg border border-blue-200 px-3 py-2 text-xs font-bold text-blue-700"><i class="fas fa-pen mr-1"></i>Editar estado</button>
